...
<body>
    <div class="topnav" id="myTopnav">
        <a href="<?php echo __SITE_URL . '/index.php?rt=home'; ?>" class="active" id="home">Home</a>
        ...
        <a href="<?php echo __SITE_URL . '/index.php?rt=report'; ?>" id="report">Report</a>
        <a href="<?php echo __SITE_URL . '/index.php?rt=logout'; ?>" id="logout">Log out</a>
